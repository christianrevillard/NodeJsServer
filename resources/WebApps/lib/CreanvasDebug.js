...
(function() {
  ...
  creanvas.NodeJsElement = function(controller, identificationData, imageData, positionData) {
    ...
    setInterval(function() {
      ...
      element.elementX += .5 * ((element.updated["elementX"] === undefined ? element.elementX : element.updated["elementX"]) - element.elementX);
      element.elementY += .5 * ((element.updated["elementY"] === undefined ? element.elementY : element.updated["elementY"]) - element.elementY);
      element.elementZ += .5 * ((element.updated["elementZ"] === undefined ? element.elementZ : element.updated["elementZ"]) - element.elementZ);
      element.elementScaleX += .5 * ((element.updated["elementScaleX"] === undefined ? element.elementScaleX : element.updated["elementScaleX"]) - element.elementScaleX);
      element.elementScaleY += .5 * ((element.updated["elementScaleY"] === undefined ? element.elementScaleY : element.updated["elementScaleY"]) - element.elementScaleY);
      element.elementAngle += .5 * ((element.updated["elementAngle"] === undefined ? element.elementAngle : element.updated["elementAngle"]) - element.elementAngle);
    }, 5);
  };
  var setIdentification = function(element, identificationData) {
    element.elementName = identificationData;
